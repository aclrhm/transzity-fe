...
export default function HomePage() {
  ...
  const busIconUri = Asset.fromModule(require("../assets/images/location.png")).uri;
        ...
        {activeTab === "home" ? (
          ...
          >
            ...
            <View style={styles.transport}>
              ...
              >
                <View
                  style={[styles.iconWrapper, { backgroundColor: "#3b6ef5" }]}
                >
                    ...
                    html: `
                      ...
                      <html>
                        ...
                        <body style="margin:0;padding:0;">
                          ...
                          <script>
                            var map = L.map('map').setView([${busPosition.latitude}, ${busPosition.longitude}], 15);
                            ...
                            L.marker([${busPosition.latitude}, ${busPosition.longitude}], { icon: busIcon })
                              .addTo(map)
                              .bindPopup('Bus ${busPosition.no_bus || ""}');

                            L.marker([${stopPosition.latitude}, ${stopPosition.longitude}])
                              .addTo(map)
                              .bindPopup('Halte Tujuan');
...
const styles = StyleSheet.create({
  ...
  iconProfile: { backgroundColor: "#3b6ef5", padding: 8, borderRadius: 50 },
  dropdown: {
    position: "absolute",
    top: 80,
    left: 0,
  ...
  transport: { flexDirection: "row", justifyContent: "space-around", marginBottom: 40},
